  ...
  htmlMaker: (respObj) => {
    ...
    * {
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="color: #444444; line-height: 170%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;">Simplemente copia y pega el siguiente enlace en su navegador: "${process.env.BACK_END_BASE_URL}/api/v1/verify/${verificationKey}"</span></p>
      </div>
